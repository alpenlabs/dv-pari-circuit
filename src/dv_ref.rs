...
mod test {
    ...
    fn test_verify_over_mock_inputs() {
        ...
        let proof = ProofRef {
            commit_p: [
                145, 195, 86, 210, 230, 219, 176, 179, 148, 236, 194, 133, 166, 240, 60, 111, 152,
                154, 62, 190, 248, 224, 197, 250, 131, 57, 145, 237, 213, 0,
            ],
            kzg_k: [
                239, 6, 89, 163, 169, 250, 184, 159, 153, 181, 70, 47, 167, 56, 153, 92, 52, 197,
                196, 244, 10, 197, 235, 26, 46, 57, 18, 194, 56, 0,
            ],
            a0: FrRef::from_str(
